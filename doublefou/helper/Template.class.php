...
{
	/**
	 * Utiliser le template d'une categorie ou de son parent
	 * Pour le thème enfant uniquement
	 */
	...
	/**
	 * Utiliser un template différent en fonction des single post categorie
	 * Dans le theme enfant uniquement
	 * exemple : single-mycategory.php 
	 */
