<?php 
	...
	Class Theme extends Singleton
	{
		...
		public static function disableEmoji(){
			...
			add_action( 'init', 'dfwp_disableEmoji' );

			function dfwp_disableEmoji(){
				...
				add_filter( 'tiny_mce_plugins', 'dfwp_disableEmojiconsTinymce' );
			}
			
			function dfwp_disableEmojiconsTinymce( $plugins ) {
				if ( is_array( $plugins ) ) {
